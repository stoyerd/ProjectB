...
//        updateButton.setVisibility(View.INVISIBLE);
        ...
        scanBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TextView myTextView = (TextView) findViewById(R.id.txtContent);
                ...
                myTextView.setText(getValueOfBarCode(myBitmap));
            }
        });
    }
...
//        }
	...
	/**
	* Takes a bitmap as input and returns a 
	* string representing the value of the barcode
	*/
	protected String getValueOfBarCode(Bitmap bitmapInput)  {
        TextView myTextView = (TextView) findViewById(R.id.txtContent);
